...
public class PatientManager {
	...
	public Patients getPatientByName(String patientName) {
	...
	public void getPatientDescription(String patientName) {
		...
		try {
			...
			if (rs.next()) {
				...
				description = new Description(rs.getInt("description_id"), rs.getString("gender"),
						rs.getString("cause"), rs.getInt("patient_id"));
	...
	public Description getDescriptionOfPatientById(int patientId) {
		String sql = "SELECT d.* FROM Descriptions d JOIN Patients p ON d.description_id = p.description_id WHERE p.patients_id = ?";
		Description description = null;
		...
		try {
			...
			if (rs.next()) {
				description = new Description(rs.getInt("description_id"), rs.getString("gender"),
						rs.getString("cause"), patientId);
			} else {
				System.out.println("No description found for patient ID: " + patientId);
