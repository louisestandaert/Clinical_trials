...
public class PatientsWithTheSameCauseController {
    ...
    private void handleSearchPatients() {
        try {
            ...
            if (cause.isEmpty()) {
                patientsArea.clear();
                messageLabel.setText("Please enter a cause.");
                return;
            }

            Set<Patients> patients = pm.getListOfPatientsWithSameCause(cause);

            if (patients == null || patients.isEmpty()) {
                patientsArea.clear();
                messageLabel.setText("No patients found with this cause.");
                return;
            }
