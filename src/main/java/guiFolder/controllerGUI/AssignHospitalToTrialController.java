...
public class AssignHospitalToTrialController {
	...
	@FXML
	private void handleAssignHospitalToTrial() {
		try {
			int hospitalId = Integer.parseInt(hospitalIdField.getText());
			int trialId = Integer.parseInt(trialIdField.getText());
			htm.assignTrialToHospital(trialId, hospitalId);
			messageLabel.setText("Hospital assigned to trial.");
